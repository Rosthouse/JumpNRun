...
namespace DebugPrimitives.Primitives
{
    public class Line: BasePrimitive
    {
        ...
        public Line(GraphicsDevice graphicsDevice): this(graphicsDevice, Color.White)
        {
        }

        public Line(GraphicsDevice graphicsDevice, Color color): this(graphicsDevice, color, Vector2.Zero, Vector2.Zero)
        {
        }

        public Line(GraphicsDevice graphicsDevice, Color color, Vector2 vector1, Vector2 vector2)
            : base(graphicsDevice, color)
        {
